...
ggsave(
  "outs/pdac_comp_reanno/figures/20_pdac_comp_reannoartment_ds_ablate_methods_nclusters.pdf",
  width = 12,
  height = 7,
  device = cairo_pdf
)
...
CairoPDF(
  "outs/pdac_comp_reanno/figures/20_celltype_ari_ds_effects_heatmap.pdf",
  width = 8, 
  height = 4
)
draw(
...
CairoPDF(
  "outs/pdac_comp_reanno/figures/20_batch_ari_ds_effects_heatmap.pdf", 
  width = 8, 
  height = 4
)
draw(
...
ggplot(data = imba_knn_merged_celltype, aes(x = `Method`, y = `F1-score`)) +
  ...
  theme(legend.text = element_text(size = 16))
ggsave(
  "outs/pdac_comp_reanno/figures/20_pdac_comp_reannoartment_ds_ablate_methods_knn_f1_score.pdf",
  width = 16,
  height = 7,
  device = cairo_pdf
)
...
ggplot(
  ...
  theme(legend.text = element_text(size = 16))
ggsave(
  "outs/pdac_comp_reanno/figures/20_pdac_comp_reannoartment_batches_celltype_n_cells.pdf",
  width = 7,
  height = 5,
  device = cairo_pdf
)
...
#############################################################################
### REDO ALL PLOTS ABOVE WITHOUT LIGER ###
#############################################################################
rm(list = ls())
gc()
...
ggplot(data = imba_clus_merged, aes(
  ...
  theme(legend.text = element_text(size = 16))
ggsave(
  "outs/pdac_comp_reanno/figures/20_pdac_comp_reannoartment_ds_ablate_methods_nclusters_no_liger.pdf",
  width = 12,
  height = 7,
  device = cairo_pdf
)
...
celltype_ari_hm <- ht1 + ht2 + ht3
CairoPDF(
  "outs/pdac_comp_reanno/figures/20_celltype_ari_ds_effects_heatmap_no_liger.pdf",
  width = 8,
  height = 4
)
draw(
...
batch_ari_hm <- ht1 + ht2 + ht3
CairoPDF(
  "outs/pdac_comp_reanno/figures/20_batch_ari_ds_effects_heatmap_no_liger.pdf", 
  width = 8, 
  height = 4
)
draw(
...
ggplot(data = imba_knn_merged_celltype, aes(x = `Method`, y = `F1-score`)) +
  ...
  theme(legend.text = element_text(size = 16))
ggsave(
  "outs/pdac_comp_reanno/figures/20_pdac_comp_reannoartment_ds_ablate_methods_knn_f1_score_no_liger.pdf",
  width = 16,
  height = 7,
  device = cairo_pdf
)
...
ggplot(data = imba_knn_merged, aes(x = `Method`, y = `F1-score`)) +
  ...
  theme(legend.text = element_text(size = 16))
ggsave(
  "outs/pdac_comp_reanno/figures/20_pdac_non_compart_specific_ds_ablate_methods_knn_f1_score_no_liger.pdf",
  width = 24,
  height = 12,
  device = cairo_pdf
)
...
ggplot(
  ...
  theme(legend.text = element_text(size = 16))
ggsave(
  "outs/pdac_comp_reanno/figures/20_pdac_comp_reannoartment_batches_celltype_n_cells_no_liger.pdf",
  width = 7,
  height = 5,
  device = cairo_pdf
)
