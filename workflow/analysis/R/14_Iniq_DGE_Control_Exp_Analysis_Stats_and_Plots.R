...
##### Analysis of PBMC 2 batch balanced data - controlled setting #####
...
### Plot the concordance of DGE for marker genes before and after 
### downsampling 
...
# Add a dummy variable for Method to allow for plotting
imba_dge_merged$Method <- "Control"
...
ggsave(
  paste0(
    "outs/dge_control_exp/figures/14_control_pbmc_ds_ablate_",
...
### Supplementary - Heatmap of marker gene perturbation scores across methods,
...
CairoPDF(
  "outs/dge_control_exp/figures/14_control_marker_gene_pert_pbmc_control_heatmap.pdf",
  width = 14, 
  height = 6
)
draw(
...
CairoPDF(
  "outs/dge_control_exp/figures/14_control_marker_gene_pert_pbmc_control_heatmap_no_ctype.pdf",
  width = 14, 
  height = 6
)
draw(
...
### Supplementary - Concordance of DGE genes - top 10 most variable marker
...
ggsave(
  paste0(
    "outs/dge_control_exp/figures/14_control_pbmc_ds_ablate_dge_rankings_top_10_var_genes.pdf"
  ),
  width = 14,
  height = 8,
  device = cairo_pdf
...
### Supplementary - Correlation of marker gene instability and the celltype
...
ggsave(
  paste0(
    "outs/dge_control_exp/figures/14_control_pbmc_ds_only_",
...
ggsave(
  paste0(
    "outs/dge_control_exp/figures/14_control_pbmc_ablated_only_",
